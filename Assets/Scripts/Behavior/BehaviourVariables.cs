...
public static class BTVariables
{
    public const string BT_UNIT_COMMAND = "Command";
    public const string BT_UNIT_TGT_POSITION = "TargetPosition";
    public const string BT_UNIT_TGT_GAME_OBJECT = "TargetGameObject";
